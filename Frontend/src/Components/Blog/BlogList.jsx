            ...
            <div className="blog-list-left">
              <div className="blog-list-card">
                <div className="image overlay-anim1">
                  <Link to="/blog/blog-details">
                    <img
                      src="/assets/images/blog/blog-thumb01.jpg"
                      alt="Meeting Image"
                    />
                  </Link>
                </div>
                <div className="card-content">
                  ...
                  <div className="author-info">
                    <div className="author">
                      <img
                        src="/assets/images/blog/social-pr01.jpg"
                        alt="Author Image"
                      />
                      <span className="name">
                        <span>By</span> Robert Aguilar
                      </span>
                    </div>
                    <span className="date">
                  ...
                  <p className="description">
                    Conveniently extend vertical benefits and forward processes.
                    Holistically impact alternative e-commerce through 24/365
                    paradigms. Enthusiastically e-enable goal-oriented.
                  </p>
              ...
              <div className="blog-list-card">
                <div className="image overlay-anim1">
                  <Link to="/blog/blog-details">
                    <img
                      src="/assets/images/blog/blog-thumb02.jpg"
                      alt="Business Image"
                    />
                  </Link>
                </div>
                <div className="card-content">
                  ...
                  <div className="author-info">
                    <div className="author">
                      <img
                        src="/assets/images/blog/social-pr02.jpg"
                        alt="Author Image"
                      />
                      <span className="name">
                        <span>By</span> Amy Renner
                      </span>
                    </div>
                    <span className="date">
                      <i className="icon-calender"></i> August 09, 2024
              ...
              <div className="blog-list-card">
                <div className="image overlay-anim1">
                  <Link to="/blog/blog-details">
                    <img
                      src="/assets/images/blog/blog-thumb03.jpg"
                      alt="Meeting Image"
                    />
                  </Link>
                </div>
                <div className="card-content">
                  ...
                  <div className="author-info">
                    <div className="author">
                      <img
                        src="/assets/images/blog/social-pr03.jpg"
                        alt="Author Image"
                      />
                      <span className="name">
                        <span>By</span> David Lucas
                      </span>
                    </div>
                    <span className="date">
                      <i className="icon-calender"></i> August 09, 2024
              ...
              <div className="blog-list-card">
                <div className="image overlay-anim1">
                  <Link to="/blog/blog-details">
                    <img
                      src="/assets/images/blog/blog-thumb04.jpg"
                      alt="Meeting Image"
                    />
                  </Link>
                </div>
                <div className="card-content">
                  ...
                  <h3 className="title">
                    <Link to="/blog/blog-details">
                      Competently seize robust rebot maintainable
                    </Link>
                  </h3>
                  <div className="author-info">
                    <div className="author">
              ...
              <div className="blog-list-card">
                <div className="image overlay-anim1">
                  <Link to="/blog/blog-details">
                    <img
                      src="/assets/images/blog/blog-thumb05.jpg"
                      alt="Meeting Image"
                    />
                  </Link>
                </div>
                <div className="card-content">
                  ...
                  <h3 className="title">
                    <Link to="/blog/blog-details">
                      Implement customized user innovative success
                    </Link>
                  </h3>
                  <div className="author-info">
                    <div className="author">
                ...
                <div className="widget-box">
                  <div className="latest-posts">
                    <div className="post">
                      <a href="#">
                        <img
                          src="/assets/images/blog/latest-details01.jpg"
                          alt="Post Image"
                        />
                      </a>
                    ...
                    <div className="post">
                      <a href="#">
                        <img
                          src="/assets/images/blog/latest-details02.jpg"
                          alt="Post Image"
                        />
                      </a>
                      <div className="post-content">
                    ...
                    <div className="post">
                      <a href="#">
                        <img
                          src="/assets/images/blog/latest-details03.jpg"
                          alt="Post Image"
                        />
                      </a>
                      <div className="post-content">
